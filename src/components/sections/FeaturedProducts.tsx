...
const featured = [
  {
    ...
    img: 'https://images.unsplash.com/photo-1553279768-865429fa0078?w=600&q=95&crop=entropy&cs=tinysrgb&fit=max',
    emoji: '🥭',
  },
  {
    name: 'Basmati Rice',
    ...
    img: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=600&q=95&crop=entropy&cs=tinysrgb&fit=max',
    emoji: '🌾',
  },
  {
    name: 'Red Chilli',
    ...
    img: 'https://images.unsplash.com/photo-1599593004564-77d7a53e17d4?w=600&q=95&crop=entropy&cs=tinysrgb&fit=max',
    emoji: '🌶️',
  },
  {
    name: 'Fresh Onions',
    ...
    img: 'https://images.unsplash.com/photo-1508747703725-719777637510?w=600&q=95&crop=entropy&cs=tinysrgb&fit=max',
    emoji: '🧅',
  },
  {
    name: 'Turmeric',
    ...
    img: 'https://images.unsplash.com/photo-1615485500704-8e990f9900f7?w=600&q=95&crop=entropy&cs=tinysrgb&fit=max',
    emoji: '🟡',
  },
  {
    name: 'Fresh Bananas',
    ...
    img: 'https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=600&q=95&crop=entropy&cs=tinysrgb&fit=max',
    emoji: '🍌',
  },
]

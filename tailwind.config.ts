...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gold-gradient': 'linear-gradient(135deg, #D4AF37 0%, #f3d88d 50%, #b88b21 100%)',
        'navy-gradient': 'linear-gradient(135deg, #0B2E4F 0%, #172f4b 100%)',
        'hero-gradient': 'linear-gradient(135deg, rgba(11,46,79,0.96) 0%, rgba(17,55,88,0.88) 50%, rgba(11,46,79,0.96) 100%)',
      },
      animation: {
